                    ...
                    if(myUser.role.equals("Student")) {
                        ...
                        assessBtn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent myIntent = new Intent(AccountActivity.this, SelectAssessmentActivity.class);
                                myIntent.putExtra("student", myUser.full_name);
                                myIntent.putExtra("teacher", myUser.teacher);
